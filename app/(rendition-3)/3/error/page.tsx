  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#FAF6F0", padding: 20 }}>
      <div className="r3-fade-in" style={{ textAlign: "center", maxWidth: 400 }}>
        ...
        <h1 className="r3-heading" style={{ fontSize: 24, marginBottom: 8 }}>Something went wrong</h1>
        <p className="r3-muted" style={{ fontSize: 15, lineHeight: 1.6, marginBottom: 28 }}>
          An error occurred. Please retry or return to the dashboard.
        </p>
        <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
          <button className="r3-btn" onClick={() => window.location.reload()}>Retry</button>
