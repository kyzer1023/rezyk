...
export const CourseMaterialGenerationSchema: JsonSchemaObject = {
  type: "object",
  required: [
    "contentCoverage", "alignment", "difficultyProgression",
    "misconceptionRecurrence", "assessmentBalance", "gaps",
    "interventionOpportunities", "topWeakConcepts", "likelyRootCauses",
    "prioritizedActions", "dataQuality",
  ],
  properties: {
    contentCoverage: {
      type: "object",
      ...
      properties: {
        ...
        gapConcepts: { type: "array", items: { type: "string" }, description: "Concepts taught but not assessed, or assessed but under-represented." },
      },
    },
    alignment: {
      type: "object",
    ...
    difficultyProgression: {
      ...
      properties: {
        assessment: { type: "string", enum: ["well_sequenced", "needs_improvement", "insufficient_data"] },
        summary: { type: "string" },
      },
    },
    misconceptionRecurrence: {
